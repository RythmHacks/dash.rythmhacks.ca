...
const Register = () => {
    ...
    // const msgs = [
    //     "You haven't started your registration! Click the button below to begin.",
    //     "Click the button below to continue your registration.",
    //     "Your registration has been successfully submitted! You can continue to edit it until the deadline.",
    // ];
    ...
    //                 <p>
    //                     This is the hub for your RythmHacks registration. Fill out your
    //                     registration, get a response from us, then RSVP for the event.
    //                 </p>
    //             </div>
    //             <h2>You're invited!</h2>
    //             <p>
    //                 Congratulations! We'd like to extend an offer for you to attend this year's
    //                 event.
    //                 <br />
    //                 <br />
    //                 Welcome to RythmHacks 2023! We are excited to offer you the opportunity to hack
    //                 with us.
    //                 <br />
    //                 <br />
    ...
    //                 className="mt-4"
    //                 onClick={() => {
    //                     navigate("/dashboard/register/rsvp");
    //                 }}
    //             >
    //                 RSVP to RythmHacks
    //             </button>
    ...
    //                 <p>
    //                     The registration deadline for this year's event has now passed. Thank you
    //                     for your enthusiasm, and we hope to see you at our event!
    //                 </p>
    //                 <br />
    //                 <p>
    ...
    //                     <a href="mailto:rythmhacks@gmail.com">email us</a>, check out our{" "}
    //                     <a href="https://rythmhacks.ca/" target="_blank" rel="noreferrer">
    //                         main website
    //                     </a>{" "}
    //                     or DM us on{" "}
    //                     <a
