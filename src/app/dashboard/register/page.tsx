    ...
    return (
        <div className="page w-full" id="Register">
            <div>
                <div className="container mb-4">
                    ...
                    <p>
                        This is the hub for your RythmHacks registration. Fill
                        out your registration, get a response from us, then RSVP
                        for the event.
                    </p>
                </div>
                <h2>You're invited!</h2>
                <p>
                    Congratulations! We'd like to extend an offer for you to
                    attend this year's event.
                    <br />
                    <br />
                    Welcome to RythmHacks 2023! We are excited to offer you the
                    opportunity to hack with us.
                    <br />
                    <br />
                    To continue, confirm your attendance by pressing the button
                    below.
                </p>
        ...
        {status === 'Waitlisted' && <div className="container w-full"></div>} */}
                <div className="container w-full mt-4">
                    ...
                    <p>
                        The registration deadline for this year's event has now
                        passed. Thank you for your enthusiasm, and we hope to
          ...
          <button onClick={() => {
            ...
            <button className='mt-4' disabled>Stay tuned for more info!</button>
                ...
                <div className="container w-full mt-4 dark:text-[#eee] text-textlight">
                    ...
                    Participants must be in secondary school or below as of the
                    2023-24 school year.
          ...
          Your registration will be automatically saved as you edit it. The final saved product will be your registration. You'll be able to edit it up until the deadline. */}
                    <p className="mt-4">
                        ...
                        <a href="mailto:rythmhacks@gmail.com">email us</a>,
                        check out our{" "}
                        <a
