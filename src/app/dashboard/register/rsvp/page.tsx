...
const HackerRSVP = () => {
    ...
    //             .from("waivers")
    //             .upload(
    //                 `${user?.id}.${waiver.name.split(".")[waiver.name.split(".").length - 1]}`,
    //                 waiver,
    //                 {
    //                     upsert: false,
    //                 }
    ...
    //                 <strong>The RSVP deadline is Monday, August 21st, at 11:59 PM.</strong> Be sure
    //                 to submit the form before then!
    //             </p>
    //         </div>
    ...
    //                         checked={attending}
    //                     />
    //                     <label onClick={() => setAttending(!attending)} className="cursor-pointer">
    //                         I am attending RythmHacks in-person over the weekend of September 1-3,
    //                         and therefore require basic human necessities such as living space,
    //                         food, water, merchandise, and other amenities.
    //                     </label>
    //                 </div>
    //                 <div>
    //                     <input
    ...
    //                         checked={overnight}
    //                     />
    //                     <label onClick={() => setOvernight(!overnight)} className="cursor-pointer">
    //                         I plan on staying overnight at the venue and will bring my own amenities
    //                         such as a sleeping bag, pillow, eye mask, and toiletries. I acknowledge
    //                         that sleeping space may be highly limited and that the RythmHacks Team
    //                         recommends continue working on my project overnight at home rather than
    ...
    //                                         onChange={() => {
    //                                             setDRestrictions(
    //                                                 toggle(dRestrictions, restriction)
    //                                             );
    //                                         }}
    //                                         type="checkbox"
    //                                     />
    ...
    //                             </div>
    //                             <input
    //                                 className={`${showOther ? "block" : "hidden"} w-full`}
