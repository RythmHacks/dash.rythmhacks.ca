    ...
    [
        {
            title: "Dinner",
            description:
                "Come to the North wall to claim your pizza and snacks!",
        ...
        },
        {
            ...
            description:
                "Come meet our sponsors and learn about their companies!",
            location: "Event Space",
            startTime: "7:00 PM",
            endTime: "10:00 PM",
            height: 3,
    ...
    [
        {
            ...
            description:
                "An introduction to becoming yet another full-stack React developer.",
            startTime: "9:00 PM",
            endTime: "10:00 PM",
            height: 1,
            heightOffset: 0,
    ...
    [
        {
            ...
            description:
                "In this workshop, we will create a plugin for ChatGPT from scratch.",
            location: "Meeting Room 1",
            startTime: "2:00 PM",
            endTime: "3:00 PM",
            height: 1,
    ...
    [
        {
            title: "Freezies",
            description:
                "Cool off with some delicious water-based frozen confections.",
            location: "Food Pickup Area",
            startTime: "3:00 PM",
            endTime: "4:00 PM",
            height: 1,
    ...
    [
        {
            title: "MLH !Light",
            description:
                "Join us for this fun minigame of creating a website without seeing it first!",
            location: "Meeting Room 1",
            startTime: "7:00 PM",
            endTime: "8:00 PM",
            height: 1,
