        ...
        <>
            <div className="page w-full h-auto md:h-screen md:overflow-hidden pb-8">
                ...
                <div className="mt-4 w-full toggle flex rounded-tl-[5px] rounded-tr-[5px]">
                    <button
                        className={`style-none w-full contrast ${
                            currentDay === 0 ? "dateActive" : ""
                        }`}
                        onClick={() => {
                            setCurrentDay(0);
                    ...
                    <button
                        className={`style-none w-full contrast !border-l-0 ${
                            currentDay === 1 ? "dateActive" : ""
                        }`}
                        onClick={() => {
                            setCurrentDay(1);
                            document.getElementById("breyers")?.scrollIntoView();
                ...
                <div
                    className={`container scheduleContainer !border-t-0 !pt-0 w-full md:h-full md:overflow-y-scroll !rounded-t-none`}
                >
