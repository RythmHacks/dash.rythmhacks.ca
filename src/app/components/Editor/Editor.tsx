...
const Toolbar = (chars: any) => {
    ...
    //             <button
    //                 className={
    //                     "style-none flex items-center justify-center w-8 h-8 transition-colors rounded-md cursor-pointer hover:bg-light1 dark:hover:bg-dark3 " +
    //                     (isBold ? "bg-dark3" : "bg-transparent")
    //                 }
    //                 onClick={() => {
    ...
    //                 className={
    //                     "style-none flex items-center justify-center w-8 h-8 transition-colors rounded-md cursor-pointer hover:bg-light1 dark:hover:bg-dark3 " +
    //                     (isItalic ? "bg-dark3" : "bg-transparent")
    //                 }
    //                 onClick={() => {
    ...
    //                 className={
    //                     "style-none flex items-center justify-center w-8 h-8 transition-colors rounded-md cursor-pointer hover:bg-light1 dark:hover:bg-dark3 " +
    //                     (isUnderline ? "bg-dark3" : "bg-transparent")
    //                 }
    //                 onClick={() => {
