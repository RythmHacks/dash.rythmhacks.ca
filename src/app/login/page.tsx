    ...
    },
    {
        ...
        answer: (
            <>
                ...
                <a href="mailto:rythmhacks@gmail.com">rythmhacks@gmail.com</a> if you have any
...
const Login = () => {
    ...
    const animateLoadingDots = () => {
        setLoadingDots((prevDots) => (prevDots === "..." ? (prevDots = ".") : (prevDots += ".")));
    };
    ...
    return (
        <div>
            <div
                id="login"
                className="container !w-3/4 min-w-[270px] md:!w-1/2 mr-auto ml-auto mt-[5rem]"
            >
                <p className="hidden md:block uppercase dark:text-[#888] light:text-[#334155] text-[0.8rem] m-0">
                    log in
                </p>
            ...
            <Modal isOpened={helpModalOpened} setIsOpened={setHelpModalOpened} title="Help">
                ...
                <button className="mt-2" onClick={() => setHelpModalOpened(false)}>
                    Ok!
                </button>
            </Modal>
        </div>
