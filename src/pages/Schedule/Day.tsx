            ...
            (row[0].width ? 
              <div className="flex gap-4 h-36">
                <div
                  ...
                  style={{
                    minHeight: `${
                      row[0].height * 144 + (row[0].height - 1) * 16
                    }px`,
                    marginTop: `${
                      row[0].heightOffset * 144 + row[0].heightOffset * 16
                    }px`,
                  }}
                >
                  ...
                  <p>
                    {row[0].startTime}{" "}
                    {row[0].endTime && <span>- {row[0].endTime}</span>}{" "}
                    {row[0].location && <span>@</span>} {row[0].location}
                  </p>
                </div>
          ...
          return (
            <div className="flex gap-4 h-36">
              ...
              <div
                ...
                style={{
                  minHeight: `${
                    row[1].height * 144 + (row[1].height - 1) * 16
                  }px`,
                  marginTop: `${
                    row[1].heightOffset * 144 + row[1].heightOffset * 16
                  }px`,
                  width: `${
                    row[1].width * 100
                  }% !important`
              ...
              >
                ...
                <p>
                  {row[1].startTime}{" "}
                  {row[1].endTime && <span>- {row[1].endTime}</span>}{" "}
                  {row[1].location && <span>@</span>} {row[1].location}
                </p>
              </div>
            </div>
          );
